...
<div class="main-wrapper">
    ...
    <div class="row main-content" style="margin-bottom: 40px;">
        <div class="large-12 columns" style="direction: ltr;">
            <div class="row">
                <div class="large-12 columns" style="direction: ltr;">
                    <h3 class="yekan" style="direction: ltr;">Different packaging our products</h3>

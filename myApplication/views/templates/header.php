                    ...
                    <ul class="right">
                        ...
                        if ($this->input->get('lang'))
                        {
                            if ($this->input->get('lang') == 'fa')
                            {
                                ...
                                <li><a href="<?php echo site_url(); ?>packing" <?php if($this->router->fetch_class() == 'packing'){echo 'class="active"';} ?>><span class="yekan">بسته بندی</span></a>
                            ...
                            {
                                ?>
                                <li><a href="<?php echo site_url(); ?>?lang=en" <?php if($this->router->fetch_class() == 'home'){echo 'class="active"';} ?>><span class="yekan">Home</span></a></li>
                                <li><a href="<?php echo site_url(); ?>?lang=en#Product" <?php if($this->router->fetch_class() == 'product'){echo 'class="active"';} ?>><span class="yekan">Product</span></a>
                                <li><a href="<?php echo site_url(); ?>packing/en?lang=en" <?php if($this->router->fetch_class() == 'packing'){echo 'class="active"';} ?>><span class="yekan">packing</span></a>
                                <li><a href="<?php echo site_url(); ?>about/en?lang=en" <?php if($this->router->fetch_class() == 'about'){echo 'class="active"';} ?>><span class="yekan">About</span></a></li>
                                <li><a href="<?php echo site_url(); ?>contact/en?lang=en" <?php if($this->router->fetch_class() == 'contact'){echo 'class="active"';} ?>><span class="yekan">Contact</span></a></li>
                                <?php
                            }
                            elseif ($this->input->get('lang') == 'ar')
                            {
                                ?>
                                <li><a href="<?php echo site_url(); ?>?lang=ar" <?php if($this->router->fetch_class() == 'home'){echo 'class="active"';} ?>><span class="yekan">الصفحة الرئيسية</span></a></li>
                                <li><a href="<?php echo site_url(); ?>?lang=ar#Product" <?php if($this->router->fetch_class() == 'product'){echo 'class="active"';} ?>><span class="yekan">المنتجات</span></a>
                                <li><a href="<?php echo site_url(); ?>packing/ar?lang=ar" <?php if($this->router->fetch_class() == 'packing'){echo 'class="active"';} ?>><span class="yekan">قائمة التعبئة</span></a>
                                <li><a href="<?php echo site_url(); ?>about/ar?lang=ar" <?php if($this->router->fetch_class() == 'about'){echo 'class="active"';} ?>><span class="yekan">معلومات عنا</span></a></li>
                                <li><a href="<?php echo site_url(); ?>contact/ar?lang=ar" <?php if($this->router->fetch_class() == 'contact'){echo 'class="active"';} ?>><span class="yekan">اتصل بنا</span></a></li>
                                <?php
                            }
                        }
                        else

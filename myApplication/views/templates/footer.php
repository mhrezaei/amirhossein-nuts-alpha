            ...
            <div class="row">
                <div class="large-6 columns">
                    ...
                    if ($this->input->get('lang'))
                    {
                        ...
                        {
                            ?>
                            <h4 class="footer-title yekan">About US</h4>
                            <div class="divdott"></div>
                            <img class="botlogo" src="<?php echo assets_url(); ?>images/botlogo.png" alt="" />
                            <div style="clear: both;"></div>
                            <div class="footer_part_content">
                                <p><span class="yekan"><?php echo $about_us_en; ?></span></p>
                            </div>
                            <?php
                        }
                        ...
                        {
                            ?>
                            <h4 class="footer-title yekan" style="direction: rtl; text-align: right;">معلومات عنا</h4>
                            <div class="divdott"></div>
                            <img class="botlogo" src="<?php echo assets_url(); ?>images/botlogo.png" alt="" style="direction: rtl; float: right;" />
                            <div style="clear: both;"></div>
                            <div class="footer_part_content">
                                <p class="yekan" style="direction: rtl; text-align: justify;"><span class="yekan"><?php echo $about_us_ar; ?></span></p>
                            </div>
                            <?php
                        }
                    }
                ...
                <div class="large-3 columns">
                    ...
                    if ($this->input->get('lang'))
                    {
                        if ($this->input->get('lang') == 'fa')
                        {
                            ...
                            <div class="footer_part_content">
                                <ul class="about-info" style="direction: rtl; text-align: right;">
                                    ...
                                    <li><i class="icon-envelope" style="float: right; padding-right: 5px; padding-top: 5px; padding-left: 5px;"></i><span style="font-family: 'BNazanin'; font-size: 16px; direction: rtl; text-align: right;"><?php echo $sms; ?></span></li>
                        ...
                        {
                            ?>
                            <h4 class="footer-title yekan">Contacts</h4>
                            <div class="divdott"></div>
                            <div class="footer_part_content">
                                <ul class="about-info">
                                    ...
                                    <li><i class="icon-envelope"></i><span><?php echo $sms_en; ?></span></li>
                        ...
                        {
                            ?>
                            <h4 class="footer-title yekan" style="direction: rtl; text-align: right;">اتصالات</h4>
                            <div class="divdott"></div>
                            <div class="footer_part_content">
                                <ul class="about-info" style="direction: rtl; text-align: right;">
                                    <li><i class="icon-home" style="float: right; padding-right: 5px; padding-top: 5px; padding-left: 5px;"></i><span class="yekan" style="direction: rtl; text-align: right;"><?php echo $address_ar; ?></span></li>
                                    <li><i class="icon-phone" style="float: right; padding-right: 5px; padding-top: 5px; padding-left: 5px;"></i><span style="font-family: 'BNazanin'; font-size: 16px; direction: rtl; text-align: right;"><?php echo $tel_ar; ?></span></li>
                                    <li><i class="icon-print" style="float: right; padding-right: 5px; padding-top: 5px; padding-left: 5px;"></i><span style="font-family: 'BNazanin'; font-size: 16px; direction: rtl; text-align: right;"><?php echo $fax_ar; ?></span></li>
                                    <li><i class="icon-envelope" style="float: right; padding-right: 5px; padding-top: 5px; padding-left: 5px;"></i><span style="font-family: 'BNazanin'; font-size: 16px; direction: rtl; text-align: right;"><?php echo $sms_ar; ?></span></li>
                                    <li><i class="icon-envelope" style="float: right; padding-right: 5px; padding-top: 5px; padding-left: 5px;"></i><a href="mailto:<?php echo $site_email; ?>"><?php echo $site_email; ?></a></li>
                                </ul>
                            </div>
                            <?php
                ...
                <div class="large-3 columns">
                    ...
                    if ($this->input->get('lang'))
                    {
                        ...
                        {
                            ?>
                            <h4 class="footer-title yekan">Quick Contact</h4>
                            <div class="divdott"></div>
                            ...
                            <form method="POST" action="#" id="footer-contact-form" name="footer-contact-form">
                                <div class="footer_part_content">
                                    <div class="row">
                                        ...
                                        <div class="large-6 columns yekan">
                                            <input type="text" placeholder="Name"  name="txtName" id="txtName" class="yekan radiusInput" style="direction: rtl;" tabindex="10" />
                                        </div>
                                        <div class="large-12 columns yekan">
                                            <textarea cols="10" rows="15"  name="txtContent" id="txtContent" placeholder="Message" class="yekan radiusInput" tabindex="12" style="direction: rtl; text-align: justify;"></textarea>
                                        </div>
                                        <div class="large-5 columns yekan">
                                            <?php
                                            $qs = securityQuestion('y', NULL, FALSE, 'conFooter1');
                                            ?>
                                            <input type="text" placeholder="Answer"  name="txtQs" id="txtQs" class="yekan radiusInput" style="direction: rtl; text-align: center;" tabindex="13" />
                                            <input type="hidden"  name="txtQsKey" id="txtQsKey" value="<?php echo $qs['key']; ?>" />
                                        </div>
                                        <div class="large-7 columns yekan" style="text-align: right;">
<!--                                            <span style="line-height: 30px; direction: rtl; text-align: right; color: #2B2B2B; font-size: 12px;">حاصل عبارت --><?php //echo $qs['value']; ?><!--؟</span>-->
                                            <span style="line-height: 30px; direction: ltr; text-align: right; color: #2B2B2B; font-size: 12px;">Is 2 plus 5?</span>
                                        </div>
                                        <div class="large-12 columns text-right yekan radiusInput">
                                            <input type="button" class="button radiusInput" value="Send" name="send" style="float: right;" onclick="footerContact();" tabindex="14" />
                                            <img src="<?php echo assets_url(); ?>images/load1.gif" alt="loading" style="float: right; margin-right: 10px; margin-top: 15px; display: none;" id="footerContactLoading" >
                                            <span style="float: right; margin-right: 10px; margin-top: 15px; direction: rtl; display: none;" id="footerContactStr"></span>
                                        </div>
                                    </div>
                        ...
                        {
                            ?>
                            <h4 class="footer-title yekan" style="direction: rtl; text-align: right;">روابط سريعة</h4>
                            <div class="divdott"></div>
                            ...
                            <form method="POST" action="#" id="footer-contact-form" name="footer-contact-form">
                                <div class="footer_part_content">
                                    <div class="row">
                                        ...
                                        <div class="large-6 columns yekan">
                                            <input type="text" placeholder="اسم"  name="txtName" id="txtName" class="yekan radiusInput" style="direction: rtl;" tabindex="10" />
                                        </div>
                                        <div class="large-12 columns yekan">
                                            <textarea cols="10" rows="15"  name="txtContent" id="txtContent" placeholder="رسالة" class="yekan radiusInput" tabindex="12" style="direction: rtl; text-align: justify;"></textarea>
                                        </div>
                                        <div class="large-5 columns yekan">
                                            <?php
                                            $qs = securityQuestion('y', NULL, FALSE, 'conFooter1');
                                            ?>
                                            <input type="text" placeholder="رد"  name="txtQs" id="txtQs" class="yekan radiusInput" style="direction: rtl; text-align: center;" tabindex="13" />
                                            <input type="hidden"  name="txtQsKey" id="txtQsKey" value="<?php echo $qs['key']; ?>" />
                                        </div>
                                        <div class="large-7 columns yekan" style="text-align: right;">
                                            <span style="line-height: 30px; direction: rtl; text-align: right; color: #2B2B2B; font-size: 12px;">العبارة <?php echo $qs['value']; ?>؟</span>
                                        </div>
                                        <div class="large-12 columns text-right yekan radiusInput">
                                            <input type="button" class="button radiusInput" value="إرسال" name="send" style="float: right;" onclick="footerContact();" tabindex="14" />
                                            <img src="<?php echo assets_url(); ?>images/load1.gif" alt="loading" style="float: right; margin-right: 10px; margin-top: 15px; display: none;" id="footerContactLoading" >
                                            <span style="float: right; margin-right: 10px; margin-top: 15px; direction: rtl; display: none;" id="footerContactStr"></span>
                                        </div>
                                    </div>
        ...
        <div class="footer-part">
            <div class="row">
                <div class="large-10 columns copyright">
                    <p style="font-size: 14px;">&copy; 2013 - <?php echo date('Y'); ?> Amir Hossein Nuts, All Rights Reserved. | Designed & Programming By <a href="http://yasnateam.com" target="_blank" style="color: #fff2db;">Yasnateam.Com</a></p>
                </div>
...
<?php
    ...
    <script type="text/javascript">
        function initialize() {
            var mapOptions = {
                center: new google.maps.LatLng(35.7399589 , 51.4680107),
                zoom: 16,
                mapTypeId: google.maps.MapTypeId.ROADMAP
            };
            var map = new google.maps.Map(document.getElementById("map_canvas"),
                mapOptions);
            var myLatlng = new google.maps.LatLng(35.7399589 , 51.4680107);

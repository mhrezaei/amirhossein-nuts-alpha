<div class="row main-navigation">
    <div class="large-3 columns">
        <a class="langBtn" href="<?php echo base_url(); ?>?lang=fa">Fa</a>
        <a class="langBtn" href="<?php echo base_url(); ?>?lang=en">En</a>
        <a class="langBtn" href="<?php echo base_url(); ?>?lang=ar">Ar</a>
    </div>

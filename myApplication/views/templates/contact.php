    ...
    <div class="content_wrapper">
        <div class="row">
            <div class="large-3 columns">
                ...
                <h3 class="contact_title yekan" style="direction: rtl; text-align: right;">ساعات کاری ما</h3>
                        ...
                        <div class="row">
                            <form method="POST" class="contactForm" name="contactForm" id="contactForm">
                                ...
                                <div class="small-12 columns">
                                    <textarea cols="10" rows="15" placeholder="پیغام" id="txtContactMsg" name="message" class="yekan radiusInput" style="direction: rtl; text-align: justify;" tabindex="4"></textarea>
                                </div>
